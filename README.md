...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/steep-sunset-68a0
```

A live public deployment of this template is available at [https://steep-sunset-68a0.templates.workers.dev](https://steep-sunset-68a0.templates.workers.dev)
